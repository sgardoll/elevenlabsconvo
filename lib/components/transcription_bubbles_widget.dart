...
/// 2 stylish chat bubbles with left alignment for responses from an AI
/// Support Agent and right alignment for the user
class TranscriptionBubblesWidget extends StatefulWidget {
  ...
  final Future Function()? onInitCallback;
  final String agentName;
  final String? agentImage;

  @override
  State<TranscriptionBubblesWidget> createState() =>
